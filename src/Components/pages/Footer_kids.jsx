      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-primary">KidsVerse</h3>
            <p className="text-sm text-primary/70">Bringing joy and style to your little ones' wardrobe.</p>
