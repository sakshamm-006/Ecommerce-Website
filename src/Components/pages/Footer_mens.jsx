      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-primary">MenSphere</h3>
            <p className="text-sm text-primary/70">Elevate your style with timeless fashion and modern essentials.</p>
